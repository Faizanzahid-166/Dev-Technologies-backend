...
import { signup, clearError } from '../redux/authSliceTunk/authSlice.js';
...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-slate-900 via-slate-900/90 to-slate-950 p-6 relative overflow-hidden">
      {/* Ambient background glows */}
      <div className="absolute -top-16 -left-16 w-72 h-72 bg-amber-500/8 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute -bottom-16 -right-16 w-72 h-72 bg-orange-600/8 rounded-full blur-3xl pointer-events-none" />

      <div className="w-full max-w-md animate-slide-up z-10">
        <header className="flex items-center gap-3 mb-8">
          <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-amber-400 to-orange-600 flex items-center justify-center shadow-md">
        ...
        <main className="bg-slate-800/60 border border-slate-700/40 backdrop-blur-md rounded-2xl p-8 shadow-lg">
          <h2 className="text-2xl font-bold text-slate-50 mb-1">Create account</h2>
          <p className="text-sm text-slate-400 mb-6">Start managing your project dependencies with Nexus today.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-slate-200 mb-2">Full name</label>
              <input
                id="name"
                name="name"
                type="text"
